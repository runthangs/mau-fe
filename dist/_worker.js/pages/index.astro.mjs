...
import { a as reactExports } from '../chunks/_@astro-renderers_DmkUz6xk.mjs';
...
const PrayerTimes = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-gray-100", children: PRAYER_NAMES.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-6 py-3 hover:bg-gray-50 transition-colors", children: [
...
Read our full story
<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path> </svg> </a> </div> <div class="md:w-1/2 grid grid-cols-2 gap-4"> <img src="/images/03-mau-interior-prayer-hall-v2.png" alt="New Masjid Interior Rendering" class="rounded-2xl shadow-lg w-full h-64 object-cover"> <div class="bg-primary rounded-2xl p-8 flex items-center justify-center text-white text-center shadow-lg h-64"> <div> <span class="block text-5xl font-bold mb-2">15K+</span> <span class="text-sm uppercase tracking-wide opacity-90">Muslims in Watford</span> </div> </div> <div class="bg-accent rounded-2xl p-6 flex items-center justify-center text-white text-center shadow-lg h-64"> <div> <span class="block text-4xl font-bold mb-2">30,000</span> <span class="text-sm uppercase tracking-wide opacity-90">Sq Ft New Facility</span> </div> </div> <img src="/images/10-mau-interior-peace-garden.png" alt="New Masjid Exterior Rendering" class="rounded-2xl shadow-lg w-full h-64 object-cover"> </div> </div> </div> </section>  <section class="py-16 bg-white"> <div class="container mx-auto px-4"> <div class="text-center max-w-3xl mx-auto mb-12"> <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">Inside the New Masjid</h2> <p class="text-gray-600">A glimpse into the world-class facilities we're building for our community.</p> </div> <div class="grid grid-cols-2 md:grid-cols-5 gap-4"> <a href="/gallery" class="group relative aspect-square overflow-hidden rounded-xl shadow-lg"> <img src="/images/01-mau-interior-foyer-cafe-v2.png" alt="Community Café & Foyer" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"> <span class="text-white font-semibold text-sm">Community Café</span> </div> </a> <a href="/gallery" class="group relative aspect-square overflow-hidden rounded-xl shadow-lg"> <img src="/images/mau-interior-sports-hall.png" alt="Sports Hall" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"> <span class="text-white font-semibold text-sm">Sports Hall</span> </div> </a> <a href="/gallery" class="group relative aspect-square overflow-hidden rounded-xl shadow-lg"> <img src="/images/05-mau-interior-gym.png" alt="Fitness Suite" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"> <span class="text-white font-semibold text-sm">Fitness Suite</span> </div> </a> <a href="/gallery" class="group relative aspect-square overflow-hidden rounded-xl shadow-lg"> <img src="/images/08-mau-interior-womens-prayer-v2.png" alt="Women's Prayer Space" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"> <span class="text-white font-semibold text-sm">Women's Prayer</span> </div> </a> <a href="/gallery" class="group relative aspect-square overflow-hidden rounded-xl shadow-lg col-span-2 md:col-span-1"> <img src="/images/07-mau-interior-classroom.png" alt="Classroom & Madrasah" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4"> <span class="text-white font-semibold text-sm">Classroom</span> </div> </a> </div> <div class="text-center mt-8"> <a href="/gallery" class="inline-flex items-center gap-2 text-primary font-semibold hover:text-accent transition-colors">
View Full Gallery
<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"> <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path> </svg> </a> </div> </div> </section>  <section class="py-20 bg-secondary"> <div class="container mx-auto px-4"> <div class="text-center max-w-3xl mx-auto mb-16"> <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">Our Core Values</h2> <p class="text-gray-600">Built on a foundation of faith, service, and community growth.</p> </div> <div class="grid grid-cols-1 md:grid-cols-3 gap-8"> ${[
    {
...
}, "C:/Users/kashi/Documents/mau-fe/src/pages/index.astro", void 0);

const $$file = "C:/Users/kashi/Documents/mau-fe/src/pages/index.astro";
const $$url = "";
